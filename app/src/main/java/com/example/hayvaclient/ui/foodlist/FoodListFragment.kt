...
import com.example.hayvaclient.hayVa.MyFoodListAdapter
...
class FoodListFragment : Fragment() {
    ...
    private fun initViews(root: View?) {
        ...
        (activity as AppCompatActivity).supportActionBar!!.title = com.example.hayvaclient.Common.Common.categorySelected!!.name
